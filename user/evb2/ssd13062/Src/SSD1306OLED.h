/******************************************************************************
 SSD1306 OLED driver for MCU007 (SSD1306OLED.c)                   			  *
 Modify for MCU007 M0 PUF MCU														  *
																			  *
...
#ifndef __SSD1306OLED__
#define __SSD1306OLED__
...
void SSD1306_DisplayRotate(uint8_t r);
void SSD1306_DisplayOnOFF(bool onOff);
void SSD1306_LeftHScrol(uint8_t start_page, uint8_t frame, uint8_t end_page);
void SSD1306_RightHScrol(uint8_t start_page, uint8_t frame, uint8_t end_page);


#endif /* __SSD1306OLED__ */
